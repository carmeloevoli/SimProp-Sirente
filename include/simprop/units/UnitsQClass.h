...
#ifndef SIMPROP_UNITSQUANTITY_H
#define SIMPROP_UNITSQUANTITY_H
...
template <typename LengthDim, typename TimeDim, typename MassDim, typename ECurrentDim, typename TemperatureDim,
          typename SubstanceDim, typename LIntensityDim, typename AngleDim, typename SolidAngleDim>
class Quantity {
 private:
  double value;
 ...
 public:
  ...
  constexpr double convertTo(const Quantity &rhs) const { return value / rhs.value; }
...
template <typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A, typename SA>
...
template <typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> operator-(const Quantity<l, t, m, I, T, N, J, A, SA> &rhs) {
  return Quantity<l, t, m, I, T, N, J, A, SA>(-1 * static_cast<double>(rhs));
}

// Addition (X+Y)
template <typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> operator+(const Quantity<l, t, m, I, T, N, J, A, SA> &lhs,
...
// Multiplication (X*Y)
template <typename l1, typename t1, typename m1, typename I1, typename T1, typename N1, typename J1, typename A1,
          typename SA1, typename l2, typename t2, typename m2, typename I2, typename T2, typename N2, typename J2,
          typename A2, typename SA2>
constexpr Quantity<std::ratio_add<l1, l2>, std::ratio_add<t1, t2>, std::ratio_add<m1, m2>, std::ratio_add<I1, I2>,
                   std::ratio_add<T1, T2>, std::ratio_add<N1, N2>, std::ratio_add<J1, J2>, std::ratio_add<A1, A2>,
...
operator*(const Quantity<l1, t1, m1, I1, T1, N1, J1, A1, SA1> &lhs,
  ...
  return Quantity<std::ratio_add<l1, l2>, std::ratio_add<t1, t2>, std::ratio_add<m1, m2>, std::ratio_add<I1, I2>,
                  std::ratio_add<T1, T2>, std::ratio_add<N1, N2>, std::ratio_add<J1, J2>, std::ratio_add<A1, A2>,
                  std::ratio_add<SA1, SA2>>(static_cast<double>(lhs) * static_cast<double>(rhs));
}
...
template <typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> operator*(const double &lhs,
                                                         const Quantity<l, t, m, I, T, N, J, A, SA> &rhs) {
...
template <typename l1, typename t1, typename m1, typename I1, typename T1, typename N1, typename J1, typename A1,
          typename SA1, typename l2, typename t2, typename m2, typename I2, typename T2, typename N2, typename J2,
          typename A2, typename SA2>
constexpr Quantity<std::ratio_subtract<l1, l2>, std::ratio_subtract<t1, t2>, std::ratio_subtract<m1, m2>,
                   std::ratio_subtract<I1, I2>, std::ratio_subtract<T1, T2>, std::ratio_subtract<N1, N2>,
                   std::ratio_subtract<J1, J2>, std::ratio_subtract<A1, A2>, std::ratio_subtract<SA1, SA2>>
operator/(const Quantity<l1, t1, m1, I1, T1, N1, J1, A1, SA1> &lhs,
          const Quantity<l2, t2, m2, I2, T2, N2, J2, A2, SA2> &rhs) {
  return Quantity<std::ratio_subtract<l1, l2>, std::ratio_subtract<t1, t2>, std::ratio_subtract<m1, m2>,
                  std::ratio_subtract<I1, I2>, std::ratio_subtract<T1, T2>, std::ratio_subtract<N1, N2>,
                  std::ratio_subtract<J1, J2>, std::ratio_subtract<A1, A2>, std::ratio_subtract<SA1, SA2>>(
...
operator/(double x, const Quantity<l, t, m, I, T, N, J, A, SA> &rhs) {
  return Quantity<std::ratio_subtract<std::ratio<0>, l>, std::ratio_subtract<std::ratio<0>, t>,
                  ...
                  std::ratio_subtract<std::ratio<0>, T>, std::ratio_subtract<std::ratio<0>, N>,
                  std::ratio_subtract<std::ratio<0>, J>, std::ratio_subtract<std::ratio<0>, A>,
                  std::ratio_subtract<std::ratio<0>, SA>>(x / static_cast<double>(rhs));
}

// Division with scalar (X/a)
template <typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> operator/(const Quantity<l, t, m, I, T, N, J, A, SA> &lhs, double rhs) {
  return Quantity<l, t, m, I, T, N, J, A, SA>(static_cast<double>(lhs) / rhs);
}
...
template <typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> fabs(const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
  return Quantity<l, t, m, I, T, N, J, A, SA>(std::fabs(static_cast<double>(num)));
}

template <typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> floor(const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
  return Quantity<l, t, m, I, T, N, J, A, SA>(std::floor(static_cast<double>(num)));
}

template <typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> round(const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
...
template <typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A, typename SA>
constexpr Quantity<l, t, m, I, T, N, J, A, SA> fmod(const Quantity<l, t, m, I, T, N, J, A, SA> &first,
                                                    const Quantity<l, t, m, I, T, N, J, A, SA> &second) {
  return Quantity<l, t, m, I, T, N, J, A, SA>(std::fmod(static_cast<double>(first), static_cast<double>(second)));
}

// sqrt()
template <typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A, typename SA>
constexpr Quantity<
    std::ratio_divide<l, std::ratio<2>>, std::ratio_divide<t, std::ratio<2>>, std::ratio_divide<m, std::ratio<2>>,
    std::ratio_divide<I, std::ratio<2>>, std::ratio_divide<T, std::ratio<2>>, std::ratio_divide<N, std::ratio<2>>,
    std::ratio_divide<J, std::ratio<2>>, std::ratio_divide<A, std::ratio<2>>, std::ratio_divide<SA, std::ratio<2>>>
...
// pow()
template <int exponent, typename l, typename t, typename m, typename I, typename T, typename N, typename J, typename A,
          typename SA>
...
pow(const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
  return Quantity<std::ratio_multiply<l, std::ratio<exponent>>, std::ratio_multiply<t, std::ratio<exponent>>,
                  ...
                  std::ratio_multiply<T, std::ratio<exponent>>, std::ratio_multiply<N, std::ratio<exponent>>,
                  std::ratio_multiply<J, std::ratio<exponent>>, std::ratio_multiply<A, std::ratio<exponent>>,
                  std::ratio_multiply<SA, std::ratio<exponent>>>(std::pow(static_cast<double>(num), exponent));
}

// pow() with rational exponent
template <int exp_nom, int exp_denom, typename l, typename t, typename m, typename I, typename T, typename N,
          typename J, typename A, typename SA>
constexpr Quantity<
    std::ratio_multiply<l, std::ratio<exp_nom, exp_denom>>, std::ratio_multiply<t, std::ratio<exp_nom, exp_denom>>,
    std::ratio_multiply<m, std::ratio<exp_nom, exp_denom>>, std::ratio_multiply<I, std::ratio<exp_nom, exp_denom>>,
    std::ratio_multiply<T, std::ratio<exp_nom, exp_denom>>, std::ratio_multiply<N, std::ratio<exp_nom, exp_denom>>,
    std::ratio_multiply<J, std::ratio<exp_nom, exp_denom>>, std::ratio_multiply<A, std::ratio<exp_nom, exp_denom>>,
...
pow(const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
  return Quantity<
      ...
      std::ratio_multiply<T, std::ratio<exp_nom, exp_denom>>, std::ratio_multiply<N, std::ratio<exp_nom, exp_denom>>,
      std::ratio_multiply<J, std::ratio<exp_nom, exp_denom>>, std::ratio_multiply<A, std::ratio<exp_nom, exp_denom>>,
      std::ratio_multiply<SA, std::ratio<exp_nom, exp_denom>>>(std::pow(static_cast<double>(num), exp_nom / exp_denom));
}
...
squared(const Quantity<l, t, m, I, T, N, J, A, SA> &num) {
  return Quantity<std::ratio_multiply<l, std::ratio<2>>, std::ratio_multiply<t, std::ratio<2>>,
                  ...
                  std::ratio_multiply<T, std::ratio<2>>, std::ratio_multiply<N, std::ratio<2>>,
                  std::ratio_multiply<J, std::ratio<2>>, std::ratio_multiply<A, std::ratio<2>>,
                  std::ratio_multiply<SA, std::ratio<2>>>(static_cast<double>(num) * static_cast<double>(num));
}
...
#define QUANTITY_TYPE(_ldim, _tdim, _mdim, _Idim, _Tdim, _Ndim, _Jdim, _Adim, _SAdim, name)                         \
  typedef Quantity<std::ratio<_ldim>, std::ratio<_tdim>, std::ratio<_mdim>, std::ratio<_Idim>, std::ratio<_Tdim>,   \
                   std::ratio<_Ndim>, std::ratio<_Jdim>, std::ratio<_Adim>, std::ratio<_SAdim>>                     \
      name;                                                                                                         \
  typedef Quantity<                                                                                                 \
      std::ratio_multiply<std::ratio<_ldim>, std::ratio<2>>, std::ratio_multiply<std::ratio<_tdim>, std::ratio<2>>, \
