...
//  Note that this model does not cover the same energy range as other URB models. Here, only ~10
//  MHz - 10 GHz is considered. Therefore, it only makes sense to use this model in very specific
//  studies.
